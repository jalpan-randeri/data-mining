...
public class FileUtils {
     ...
     * @param input String representing the input file which is being split
     * @param output_dir String representing the output file directory
     * @throws IOException
     */
    public static void split_file(String input, String output_dir) throws IOException {
        BufferedReader reader = new BufferedReader(new FileReader(input));
        String line = null;
        int count = 0;
        PrintWriter writer50 = new PrintWriter(output_dir+"/50(1000)_100_train.csv");
        PrintWriter writer100 = new PrintWriter(output_dir+"/100(1000)_100_train.csv");
        PrintWriter writer150 = new PrintWriter(output_dir+"/150(1000)_100_train.csv");
